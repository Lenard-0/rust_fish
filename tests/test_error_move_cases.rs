...
mod tests {
    ...
    fn cannot_move_piece_when_wrong_turn() {
        ...
        let possible_moves = calculate_possible_moves(4, 4, &mut board, true, false, &None, &mut CastleState::new(), false);
    ...
    fn cannot_move_piece_when_wrong_turn_alt_color() {
        ...
        let possible_moves = calculate_possible_moves(4, 4, &mut board, true, true, &None, &mut CastleState::new(), false);
        assert!(possible_moves.is_err());
    }
}