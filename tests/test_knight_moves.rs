...
mod tests {
    ...
    fn knight_valid_moves_middle_board() {
        ...
        let possible_moves = calculate_possible_moves(4, 2, &mut board, false, true, &None, &mut CastleState::new()).unwrap();
    ...
    fn knight_valid_moves_edge_board() {
        ...
        let possible_moves = calculate_possible_moves(0, 1, &mut board, false, true, &None, &mut CastleState::new()).unwrap();
    ...
    fn knight_moves_blocked_by_same_color_alt_color() {
        ...
        let possible_moves = calculate_possible_moves(3, 3, &mut board, false, false, &None, &mut CastleState::new()).unwrap();
